...
def suite():
    ...
    # Postconditions
    test_insertPost()
    test_insertPostSameKey()
    test_deletePost()
    test_deletePostSameKey()
    test_unionPost()
    test_findPostPresent()
    test_findPostAbsent()
    test_insertDeleteComplete()

    # Metamorphic properties
    test_insertInsert()
    test_insertInsertWeak()
    test_insertDelete()
    test_insertUnion()
    test_deleteInsertWeak()
    test_deleteInsert()
    test_deleteDelete()
    test_deleteUnion()
    test_unionDeleteInsert()
    test_unionUnionIdem()
    test_unionUnionAssoc()
    test_findInsert()
    test_findDelete()
    test_findUnion()

    # Preservation of equivalence
    test_insertPreservesEquiv()
    test_deletePreservesEquiv()
    test_unionPreservesEquiv()
    test_findPreservesEquiv()
    test_equivs()

    # Inductive testing
    test_unionInsert()
    test_insertComplete()
    test_insertCompleteForDelete()
    test_insertCompleteForUnion()
